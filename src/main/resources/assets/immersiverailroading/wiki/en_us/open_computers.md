...
Placing an Adaptor next to or under a Detector Augment provides the following functions under components.ir_augment_detector:
...
Placing an Adaptor next to or under a Loco Control Augment provides the following functions under components.ir_augment_control:
